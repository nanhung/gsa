...
#define ID_lnCPL_APAP_mcgL 0x00024
#define ID_lnCPL_AG_mcgL 0x00025
#define ID_lnCPL_AS_mcgL 0x00026
#define ID_lnCU_APAP_mcg 0x00027
#define ID_lnCU_AG_mcg 0x00028
#define ID_lnCU_AS_mcg 0x00029
#define ID_lnf_abs 0x0002a
#define ID_Verr_lnCPL_APAP_mcmolL 0x0002b
#define ID_Verr_lnCPL_APAP_mcgL 0x0002c
#define ID_Verr_lnCPL_AG_mcmolL 0x0002d
#define ID_Verr_lnCPL_AG_mcgL 0x0002e
#define ID_Verr_lnCPL_AS_mcmolL 0x0002f
#define ID_Verr_lnCPL_AS_mcgL 0x00030
#define ID_Verr_lnCU_APAP_mcg 0x00031
#define ID_Verr_lnCU_AG_mcg 0x00032
#define ID_Verr_lnCU_AS_mcg 0x00033

/* Parameters */
static double parms[373];
...
#define OralDose_APAP_mg parms[121]
#define OralDur_APAP parms[122]
#define ODose_APAP_mg parms[123]
#define fa parms[124]
#define ODose_APAP parms[125]
#define true_dose parms[126]
#define IVDose_APAP_mgkg parms[127]
#define lnIVDose_APAP_mgkg parms[128]
#define IVDose_APAP_mg parms[129]
#define lnIVDose_APAP_mg parms[130]
#define IVDur_APAP parms[131]
#define IVD_APAP_mg parms[132]
#define IVDR_APAP parms[133]
#define CYP_Vmax parms[134]
#define UGT_Vmax parms[135]
#define SULT_Vmax parms[136]
#define VTC parms[137]
#define VF parms[138]
#define VK parms[139]
#define VG parms[140]
#define VM parms[141]
#define VL parms[142]
#define VBLA parms[143]
#define VBLV parms[144]
#define VR parms[145]
#define VS parms[146]
#define QTC parms[147]
#define QC parms[148]
#define QF parms[149]
#define QK parms[150]
#define QG parms[151]
#define QM parms[152]
#define QLB parms[153]
#define QR parms[154]
#define QS parms[155]
#define QL parms[156]
#define CLR_APAP parms[157]
#define CLR_AS parms[158]
#define CLR_AG parms[159]
#define M_OralDose_APAP parms[160]
#define Var_OralDose_APAP parms[161]
#define M_IVDose_APAP parms[162]
#define Var_IVDose_APAP parms[163]
#define M_lnOralDose_APAP parms[164]
#define Var_lnOralDose_APAP parms[165]
#define M_lnIVDose_APAP parms[166]
#define M_lnVar_IVDose_APAP parms[167]
#define M_BW parms[168]
#define M_lnBW parms[169]
#define M_fa parms[170]
#define M_lnfa parms[171]
#define M_kSG_Vm parms[172]
#define M_lnkSG_Vm parms[173]
#define M_kSG_Km parms[174]
#define M_lnkSG_Km parms[175]
#define M_Tg parms[176]
#define M_lnTg parms[177]
#define M_Tp parms[178]
#define M_lnTp parms[179]
#define M_CLC_APAP parms[180]
#define M_lnCLC_APAP parms[181]
#define M_CLC_AS parms[182]
#define M_lnCLC_AS parms[183]
#define M_CLC_AG parms[184]
#define M_lnCLC_AG parms[185]
#define M_BP_APAP parms[186]
#define M_lnBP_APAP parms[187]
#define M_PF_APAP parms[188]
#define M_lnPF_APAP parms[189]
#define M_PG_APAP parms[190]
#define M_lnPG_APAP parms[191]
#define M_PK_APAP parms[192]
#define M_lnPK_APAP parms[193]
#define M_PL_APAP parms[194]
#define M_lnPL_APAP parms[195]
#define M_PM_APAP parms[196]
#define M_lnPM_APAP parms[197]
#define M_PR_APAP parms[198]
#define M_lnPR_APAP parms[199]
#define M_PS_APAP parms[200]
#define M_lnPS_APAP parms[201]
#define M_PK_AS parms[202]
#define M_lnPK_AS parms[203]
#define M_PF_AS parms[204]
#define M_lnPF_AS parms[205]
#define M_PL_AS parms[206]
#define M_lnPL_AS parms[207]
#define M_PG_AS parms[208]
#define M_lnPG_AS parms[209]
#define M_PM_AS parms[210]
#define M_lnPM_AS parms[211]
#define M_PR_AS parms[212]
#define M_lnPR_AS parms[213]
#define M_PS_AS parms[214]
#define M_lnPS_AS parms[215]
#define M_PK_AG parms[216]
#define M_lnPK_AG parms[217]
#define M_PF_AG parms[218]
#define M_lnPF_AG parms[219]
#define M_PL_AG parms[220]
#define M_lnPL_AG parms[221]
#define M_PG_AG parms[222]
#define M_lnPG_AG parms[223]
#define M_PM_AG parms[224]
#define M_lnPM_AG parms[225]
#define M_PR_AG parms[226]
#define M_lnPR_AG parms[227]
#define M_PS_AG parms[228]
#define M_lnPS_AG parms[229]
#define M_kPAPS parms[230]
#define M_lnkPAPS parms[231]
#define M_kPAPS_syn parms[232]
#define M_lnkPAPS_syn parms[233]
#define M_kGA parms[234]
#define M_lnkGA parms[235]
#define M_kGA_syn parms[236]
#define M_lnkGA_syn parms[237]
#define M_CYP_Km parms[238]
#define M_lnCYP_Km parms[239]
#define M_CYP_VmaxC parms[240]
#define M_lnCYP_VmaxC parms[241]
#define M_UGT_Km parms[242]
#define M_lnUGT_Km parms[243]
#define M_UGT_VmaxC parms[244]
#define M_lnUGT_VmaxC parms[245]
#define M_UGT_Km_GA parms[246]
#define M_lnUGT_Km_GA parms[247]
#define M_UGT_Ki parms[248]
#define M_lnUGT_Ki parms[249]
#define M_Vmax_AG parms[250]
#define M_lnVmax_AG parms[251]
#define M_Km_AG parms[252]
#define M_lnKm_AG parms[253]
#define M_SULT_Km_apap parms[254]
#define M_lnSULT_Km_apap parms[255]
#define M_SULT_Km_paps parms[256]
#define M_lnSULT_Km_paps parms[257]
#define M_SULT_Ki parms[258]
#define M_lnSULT_Ki parms[259]
#define M_SULT_VmaxC parms[260]
#define M_lnSULT_VmaxC parms[261]
#define M_Vmax_AS parms[262]
#define M_lnVmax_AS parms[263]
#define M_Km_AS parms[264]
#define M_lnKm_AS parms[265]
#define Var_BW parms[266]
#define Var_lnBW parms[267]
#define Var_fa parms[268]
#define Var_lnfa parms[269]
#define Var_kSG_Vm parms[270]
#define Var_lnkSG_Vm parms[271]
#define Var_kSG_Km parms[272]
#define Var_lnkSG_Km parms[273]
#define Var_Tg parms[274]
#define Var_lnTg parms[275]
#define Var_Tp parms[276]
#define Var_lnTp parms[277]
#define Var_CLC_APAP parms[278]
#define Var_lnCLC_APAP parms[279]
#define Var_CLC_AS parms[280]
#define Var_lnCLC_AS parms[281]
#define Var_CLC_AG parms[282]
#define Var_lnCLC_AG parms[283]
#define Var_BP_APAP parms[284]
#define Var_lnBP_APAP parms[285]
#define Var_PF_APAP parms[286]
#define Var_lnPF_APAP parms[287]
#define Var_PG_APAP parms[288]
#define Var_lnPG_APAP parms[289]
#define Var_PK_APAP parms[290]
#define Var_lnPK_APAP parms[291]
#define Var_PL_APAP parms[292]
#define Var_lnPL_APAP parms[293]
#define Var_PM_APAP parms[294]
#define Var_lnPM_APAP parms[295]
#define Var_PR_APAP parms[296]
#define Var_lnPR_APAP parms[297]
#define Var_PS_APAP parms[298]
#define Var_lnPS_APAP parms[299]
#define Var_PK_AS parms[300]
#define Var_lnPK_AS parms[301]
#define Var_PF_AS parms[302]
#define Var_lnPF_AS parms[303]
#define Var_PL_AS parms[304]
#define Var_lnPL_AS parms[305]
#define Var_PG_AS parms[306]
#define Var_lnPG_AS parms[307]
#define Var_PM_AS parms[308]
#define Var_lnPM_AS parms[309]
#define Var_PR_AS parms[310]
#define Var_lnPR_AS parms[311]
#define Var_PS_AS parms[312]
#define Var_lnPS_AS parms[313]
#define Var_PK_AG parms[314]
#define Var_lnPK_AG parms[315]
#define Var_PF_AG parms[316]
#define Var_lnPF_AG parms[317]
#define Var_PL_AG parms[318]
#define Var_lnPL_AG parms[319]
#define Var_PG_AG parms[320]
#define Var_lnPG_AG parms[321]
#define Var_PM_AG parms[322]
#define Var_lnPM_AG parms[323]
#define Var_PR_AG parms[324]
#define Var_lnPR_AG parms[325]
#define Var_PS_AG parms[326]
#define Var_lnPS_AG parms[327]
#define Var_kPAPS parms[328]
#define Var_lnkPAPS parms[329]
#define Var_kPAPS_syn parms[330]
#define Var_lnkPAPS_syn parms[331]
#define Var_kGA parms[332]
#define Var_lnkGA parms[333]
#define Var_kGA_syn parms[334]
#define Var_lnkGA_syn parms[335]
#define Var_CYP_Km parms[336]
#define Var_lnCYP_Km parms[337]
#define Var_CYP_VmaxC parms[338]
#define Var_lnCYP_VmaxC parms[339]
#define Var_UGT_Km parms[340]
#define Var_lnUGT_Km parms[341]
#define Var_UGT_VmaxC parms[342]
#define Var_lnUGT_VmaxC parms[343]
#define Var_UGT_Km_GA parms[344]
#define Var_lnUGT_Km_GA parms[345]
#define Var_UGT_Ki parms[346]
#define Var_lnUGT_Ki parms[347]
#define Var_Vmax_AG parms[348]
#define Var_lnVmax_AG parms[349]
#define Var_Km_AG parms[350]
#define Var_lnKm_AG parms[351]
#define Var_SULT_KVar_apap parms[352]
#define Var_lnSULT_Km_apap parms[353]
#define Var_SULT_KVar_paps parms[354]
#define Var_lnSULT_Km_paps parms[355]
#define Var_SULT_Ki parms[356]
#define Var_lnSULT_Ki parms[357]
#define Var_SULT_VmaxC parms[358]
#define Var_lnSULT_VmaxC parms[359]
#define Var_Vmax_AS parms[360]
#define Var_lnVmax_AS parms[361]
#define Var_Km_AS parms[362]
#define Var_lnKm_AS parms[363]
#define Verr_CPL_APAP_mcmolL parms[364]
#define Verr_CPL_APAP_mcgL parms[365]
#define Verr_CPL_AG_mcmolL parms[366]
#define Verr_CPL_AG_mcgL parms[367]
#define Verr_CPL_AS_mcmolL parms[368]
#define Verr_CPL_AS_mcgL parms[369]
#define Verr_CU_APAP_mcg parms[370]
#define Verr_CU_AG_mcg parms[371]
#define Verr_CU_AS_mcg parms[372]
